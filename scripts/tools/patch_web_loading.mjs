...
// Inject CSS for black background, pulsing logo, indeterminate progress
const css = `<style>
...
// Patch the onProgress callback to cap download at 50%, then show
// indeterminate animation for the init phase (50-100%)
